...
class SplitBoxDataProcessor(BaseDataProcessor):
    ...
    def generate_grouped_serial_range(self, base_number: str, container_num: int,
        ...
        print(f"📝 分盒{container_type}标 #{container_num}: 包含盒{start_item}-{end_item}, 序列号范围={serial_range}")
        return serial_range
    ...
    def generate_split_small_box_serial_range(self, base_number: str, small_box_num: int, 
        ...
        """向后兼容包装器"""
        group_size = boxes_per_small_box * small_boxes_per_large_box
        return self.generate_grouped_serial_range(base_number, small_box_num, boxes_per_small_box, group_size, "小箱", total_boxes)
    ...
    def generate_split_large_box_serial_range(self, base_number: str, large_box_num: int,
        ...
        return self.generate_grouped_serial_range(
            base_number, large_box_num, end_box - start_box + 1, group_size, "大箱", total_boxes
        )
    ...
    def generate_linear_serial_range(self, base_number: str, container_num: int,
        ...
        """
        # 分盒模板使用复杂的主号-副号格式，默认group_size=1
        return self.generate_grouped_serial_range(base_number, container_num, items_per_container, 1, container_type, total_items)
