...
class SplitBoxTemplate(PDFBaseUtils):
    ...
    def create_multi_level_pdfs(
        ...
        if has_small_box:
            return self._create_three_level_pdfs(
                data, params, output_dir, excel_file_path
            )
        else:
    ...
    def _create_three_level_pdfs(
        ...
        small_box_filename = (
            f"{customer_code}_{chinese_name}_{english_name}_分盒小箱标_{timestamp}.pdf"
        )
        ...
        large_box_filename = (
            f"{customer_code}_{chinese_name}_{english_name}_分盒大箱标_{timestamp}.pdf"
        )
    ...
    def _create_two_level_pdfs(
        ...
        large_box_filename = (
            f"{customer_code}_{chinese_name}_{english_name}_分盒箱标_{timestamp}.pdf"
        )
        large_box_path = full_output_dir / large_box_filename
    ...
    def _create_split_box_label(
        ...
        small_boxes_per_large_box = int(params["小箱/大箱"])
        print(
            f"✅ 分盒盒标参数: 盒/小箱={boxes_per_small_box}, 小箱/大箱={small_boxes_per_large_box}"
        )
    ...
    def _create_single_split_box_label_file(
        self,
        data: Dict[str, Any],
        params: Dict[str, Any],
        output_path: str,
        ...
        if start_box == 1:
            ...
            split_box_renderer.render_blank_box_first_page(
                c, width, height, chinese_name
            )
        ...
        for box_num in range(start_box, end_box + 1):
            ...
            split_box_renderer.render_appearance_one(
                c, width, top_text, current_number, top_text_y, serial_number_y
            )

        c.save()

    def _create_split_box_small_box_label(
        self,
        data: Dict[str, Any],
        params: Dict[str, Any],
        output_path: str,
        ...
        print(
            f"✅ 分盒小箱标使用统一数据: 主题='{theme_text}', 开始号='{base_number}', 客户编码='{remark_text}'"
        )
        ...
        print(
            f"✅ 分盒小箱标参数: 盒/小箱={boxes_per_small_box}, 小箱/大箱={small_boxes_per_large_box}, 序列号字体大小={serial_font_size}"
        )
    ...
    def _create_single_split_box_small_box_label_file(
        self,
        data: Dict[str, Any],
        params: Dict[str, Any],
        output_path: str,
        ...
        if start_small_box == 1:
            ...
            if template_type == "有纸卡备注":
                split_box_renderer.render_empty_small_box_label(
                    c,
                    width,
                    height,
                    chinese_name,
        ...
        for small_box_num in range(start_small_box, end_small_box + 1):
            if (
                small_box_num > start_small_box or start_small_box == 1
            ):  # 修改条件，考虑空标签页
                if not (
                    small_box_num == start_small_box and start_small_box == 1
                ):  # 避免重复showPage
                    c.showPage()
                    c.setFillColor(cmyk_black)
            ...
            serial_range = (
                split_box_data_processor.generate_split_small_box_serial_range(
                    base_number,
                    small_box_num,
                    boxes_per_small_box,
                    small_boxes_per_large_box,
            ...
            if template_type == "有纸卡备注":
                split_box_renderer.draw_split_box_small_box_table(
                    ...
                    height,
                    theme_text,
                    actual_pieces_in_small_box,
                    serial_range,
                    carton_no,
                    remark_text,
                    has_paper_card=True,
                    serial_font_size=serial_font_size,
                )
            else:  # "无纸卡备注"
    ...
    def _create_split_box_large_box_label(
        self,
        data: Dict[str, Any],
        params: Dict[str, Any],
        output_path: str,
        ...
        remark_text = data.get("客户名称编码") or "Unknown Client"
        print(
            f"✅ 分盒大箱标使用统一数据: 主题='{theme_text}', 开始号='{base_number}', 客户编码='{remark_text}'"
        )
        ...
        serial_font_size = int(params.get("序列号字体大小", 10))
        print(
            f"✅ 分盒大箱标参数: 盒/小箱={boxes_per_small_box}, 小箱/大箱={small_boxes_per_large_box}, 序列号字体大小={serial_font_size}"
        )
    ...
    def _create_single_split_box_large_box_label_file(
        self,
        data: Dict[str, Any],
        params: Dict[str, Any],
        output_path: str,
        ...
        if start_large_box == 1:
            ...
            if template_type == "有纸卡备注":
                split_box_renderer.render_empty_large_box_label(
                    c,
                    width,
                    height,
                    chinese_name,
        ...
        for large_box_num in range(start_large_box, end_large_box + 1):
            if (
                large_box_num > start_large_box or start_large_box == 1
            ):  # 修改条件，考虑空标签页
                if not (
                    large_box_num == start_large_box and start_large_box == 1
                ):  # 避免重复showPage
                    c.showPage()
                    c.setFillColor(cmyk_black)
            ...
            # 使用数据处理器计算序列号范围
            serial_range = (
                split_box_data_processor.generate_split_large_box_serial_range(
                    base_number,
                    large_box_num,
                    small_boxes_per_large_box,
                    boxes_per_small_box,
    ...
    def _create_two_level_large_box_label(
        ...
        remark_text = data.get("客户名称编码") or "Unknown Client"
        print(
            f"✅ 分盒箱标使用统一数据: 主题='{theme_text}', 开始号='{base_number}', 客户编码='{remark_text}'"
        )
        ...
        serial_font_size = int(params.get("序列号字体大小", 10))
        print(
            f"✅ 分盒箱标参数: 盒/箱={boxes_per_large_box}, 序列号字体大小={serial_font_size}"
        )
