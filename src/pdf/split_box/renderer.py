...
class SplitBoxRenderer(BaseRenderer):
    ...
    def draw_split_box_small_box_table(
        self,
        c,
        width,
        height,
    ...
    def draw_split_box_small_box_table_no_paper_card(
        self,
        c,
        width,
        height,
    ...
    def draw_split_box_large_box_table(
        self,
        c,
        width,
        height,
    ...
    def draw_split_box_large_box_table_no_paper_card(
        self,
        c,
        width,
        height,
    ...
    def render_split_empty_box_label_no_paper_card(
    ...
    def render_empty_box_label(
        ...
        if has_paper_card:
            return self.render_split_empty_box_label(
                c, width, height, chinese_name, remark_text
            )
        else:
            return self.render_split_empty_box_label_no_paper_card(
                c, width, height, chinese_name, remark_text
            )
