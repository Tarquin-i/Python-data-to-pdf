...
class NestedBoxUIDialog(BaseUIDialog):
    ...
    def show_parameters_dialog(self):
        ...
        self.create_radio_group(
            ...
            "is_overweight", "正常", self.on_overweight_choice_changed
        )
    ...
    def confirm_parameters(self):
        ...
        try:
            ...
            boxes_per_small_box = self.validate_integer_input('boxes_per_small_box', '盒/套', 1)
            
            is_overweight = self.get_var_value("is_overweight") == "超重"
            
            if is_overweight:
                small_boxes_per_large_box = self.validate_integer_input('small_boxes_per_large_box', '一套拆多少箱', 1, boxes_per_small_box)
            else:
                small_boxes_per_large_box = self.validate_integer_input('small_boxes_per_large_box', '套/箱', 1)
    ...
    def get_template_specific_inputs(self) -> List[Dict]:
        ...
        return [
            ...
            {'label': '盒/套:', 'var_name': 'boxes_per_small_box', 'default_value': '', 'width': 15},
            {'label': '套/箱:', 'var_name': 'small_boxes_per_large_box', 'default_value': '', 'width': 15},
